            ...
            <div className="custom-px-2 boxShadow5 width44 custom-bg-8 border-radius-4">
              <ul className="p-0 list-none m-0">
                <li className="padding-27 padding47 w-full whitespace-nowrap">
                  <button className="text-[#ce4747] custom-fs-1 cursor-pointer select-none font-normal opacity-[0.8] transition-all duration-75 ease hover:opacity-100">Delete publication</button>
                </li>
              </ul>
            </div>
          </Popover.Content>
