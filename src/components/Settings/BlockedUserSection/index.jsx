        ...
        <div className="flex w-full items-baseline justify-between">
          <div className="flex items-center">
            <div className="grow shrink basis-0">
              <span className="color-3 custom-fs-1 line20 font-medium">Blocked users</span>
            </div>
          </div>
        </div>
      </button>
      {isShowModal && <BlockedUserModal isShowModal={isShowModal} handleCloseModal={handleCloseModal} />}
    </>
  );
}
