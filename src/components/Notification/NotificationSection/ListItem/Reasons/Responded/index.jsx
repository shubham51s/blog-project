      ...
      <div className="flex flex-col text-left color16 line22 group">
        <div>
          <div className="inline-flex items-center margin-23" style={{ marginLeft: 0, marginBlock: 0 }}>
            <Link to={`/profile/${item.sender.username}`} className="cursor-pointer flex items-center transition-all duration-75 ease hover:underline">
              {item.sender.name}
            </Link>
          </div>
          {/* <div className="inline-flex items-center margin-23" style={{ marginLeft: 0, marginBlock: 0 }}>
