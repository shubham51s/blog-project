...
function MakeListPrivateModal({ isPrivateListModal, handleClosePrivateListModal, makeListPrivate }) {
  const [isLoading, setIsLoading] = useState(false);

  const handleMakeListPrivateBtnClick = () => {
    makeListPrivate(setIsLoading);
  };
...
export default MakeListPrivateModal;
