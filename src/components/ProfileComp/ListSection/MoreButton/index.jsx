            ...
            <div className="grow shrink-0 basis-auto max-width-2 padding77 padding78 flex flex-col justify-center items-center">
              <div className="flex flex-col items-center">
                ...
                <div className="w-full flex justify-center">
                  ...
                  <div className="padding50" style={{ paddingRight: 0 }}>
                    <button className="bdr-3 border-[#1a8917] bg-[#1a8917] border-radius-9 text-center text-white custom-fs-1 line20 font-medium custom-px-2 padding-38 m-0 cursor-pointer opacity-[0.9] transition-all duration-75 linear hover:opacity-100">Confirm</button>
                  </div>
                </div>
              </div>
            </div>
