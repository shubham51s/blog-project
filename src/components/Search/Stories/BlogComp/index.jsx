...
function BlogComp({ item }) {
  ...
  return (
    <>
      {blog && (
        <div className={`margin51 first:!mt-0 w-full max-w-full overflow-hidden transition-all duration-500 ease-out ${isHideBlog ? "height71 !mt-0" : "height-18"}`}>
                          ...
                          <div className="margin-21 flex items-center w-full" style={{ marginTop: 0, marginInline: 0 }}>
                            ...
                            <div className="z-[2] relative cursor-pointer flex items-center grow min-w-0">
                              <div className="w-[60%] truncate text-ellipsis whitespace-nowrap color-3 height-6 font-4 custom-line-h-1">
                                ...
                                <Link to={`/publication/${blog.publication.slug}`} className="font-normal no-underline hover:underline">
                                  ...
                                  <div className="flex justify-end items-center grow-0 shrink-0 basis-0 color-6">
                                    ...
                                    <div>
                                      <div className="inline-block">
                                        <button className="z-[2] relative padding-33 cursor-pointer m-0 transition-all duration-200 ease-out opacity-[0.7] hover:opacity-100" title="Show less like this">
