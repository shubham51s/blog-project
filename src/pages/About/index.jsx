        ...
        <div className="padding-3 custom-bg-3 flex items-center justify-between bdr-2 custom-bdr-4">
          ...
          <div className="flex">
            <div className="margin-3">
              <span>
                <button onClick={() => navigate("/login")} className="cursor-pointer padding-5 custom-line-h-1 custom-fs-1 custom-bdr-6 color-5 text-center no-underline inline-block bdr-1 custom-bdr-4 rounded-full">
                  Sign in
                </button>
              </span>
            </div>
            <span>
              <button onClick={() => navigate("/register")} className="cursor-pointer color-6 padding-5 custom-line-h-1 custom-fs-1 custom-bdr-7 custom-bg-4 text-center inline-block bdr-1 rounded-full m-0 overflow-visible">
                Sign up
              </button>
            </span>
          </div>
